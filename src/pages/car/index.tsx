...
export function CarDetail() {
  ...
  useEffect(() => {
    ...
    //Remove eventListener when unmount the component (e.g. Leave the page)
    return () => {
        ...
        <>
          ...
          <main className="w-full bg-white rounded-lg p-6 my-4">
            ...
            <a
              ...
              href={`https://api.whatsapp.com/send?phone=${car?.whatsapp}&text=Olá vi o carro ${car.name} na WebCarros e tenho interesse!`}
              target="_blank"
            >
